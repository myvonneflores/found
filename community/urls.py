...
urlpatterns = [
    ...
    path("public-lists/", views.PublicCuratedListSearchView.as_view(), name="public-list-list"),
    path("public-lists/<str:id_hash>/", views.PublicCuratedListDetailView.as_view(), name="public-list-detail"),
    path("saved-lists/", views.SavedCuratedListListCreateView.as_view(), name="saved-list-list"),
    path("saved-lists/<int:pk>/", views.SavedCuratedListDetailView.as_view(), name="saved-list-detail"),
